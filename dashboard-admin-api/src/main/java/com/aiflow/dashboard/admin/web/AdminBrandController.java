...
import com.aiflow.dashboard.db.service.DashboardBrandService;
...
public class AdminBrandController {
    ...
    public Object list(String id, String name,
        ...
        List<DashboardBrand> brandList = brandService.querySelective(id, name, page, limit, sort, order);
        return ResponseUtil.okList(brandList);
    }

    private Object validate(DashboardBrand brand) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody DashboardBrand brand) {
    ...
    public Object read(@NotNull Integer id) {
        DashboardBrand brand = brandService.findById(id);
        return ResponseUtil.ok(brand);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody DashboardBrand brand) {
        Object error = validate(brand);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody DashboardBrand brand) {
