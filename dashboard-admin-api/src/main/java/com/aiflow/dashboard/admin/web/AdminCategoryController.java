...
import com.aiflow.dashboard.admin.vo.CategoryVo;
import com.aiflow.dashboard.core.util.ResponseUtil;
import com.aiflow.dashboard.db.domain.DashboardCategory;
import com.aiflow.dashboard.db.service.DashboardCategoryService;
...
public class AdminCategoryController {
    ...
    public Object list() {
        ...
        List<DashboardCategory> categoryList = categoryService.queryByPid(0);
        for (DashboardCategory category : categoryList) {
            ...
            List<DashboardCategory> subCategoryList = categoryService.queryByPid(category.getId());
            for (DashboardCategory subCategory : subCategoryList) {
    ...
    private Object validate(DashboardCategory category) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody DashboardCategory category) {
    ...
    public Object read(@NotNull Integer id) {
        DashboardCategory category = categoryService.findById(id);
        return ResponseUtil.ok(category);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody DashboardCategory category) {
        Object error = validate(category);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody DashboardCategory category) {
    ...
    public Object catL1() {
        ...
        for (DashboardCategory category : l1CatList) {
