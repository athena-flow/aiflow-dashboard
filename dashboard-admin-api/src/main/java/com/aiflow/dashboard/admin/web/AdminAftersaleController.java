...
import com.aiflow.dashboard.admin.service.LogHelper;
import com.aiflow.dashboard.admin.util.AdminResponseCode;
...
import com.aiflow.dashboard.db.util.AftersaleConstant;
...
import static com.aiflow.dashboard.admin.util.AdminResponseCode.ORDER_REFUND_FAILED;
...
public class AdminAftersaleController {
    ...
    @Autowired
    private DashboardGoodsProductService goodsProductService;
    @Autowired
    ...
    public Object list(Integer orderId, String aftersaleSn, Short status,
        ...
        List<DashboardAftersale> aftersaleList = aftersaleService.querySelective(orderId, aftersaleSn, status, page, limit, sort, order);
    ...
    @PostMapping("/recept")
    public Object recept(@RequestBody DashboardAftersale aftersale) {
        Integer id = aftersale.getId();
        DashboardAftersale aftersaleOne = aftersaleService.findById(id);
    ...
    public Object batchRecept(@RequestBody String body) {
        ...
        for(Integer id : ids) {
            DashboardAftersale aftersale = aftersaleService.findById(id);
            if(aftersale == null){
                continue;
            }
    ...
    @PostMapping("/reject")
    public Object reject(@RequestBody DashboardAftersale aftersale) {
        Integer id = aftersale.getId();
        DashboardAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
    ...
    @PostMapping("/refund")
    public Object refund(@RequestBody DashboardAftersale aftersale) {
        Integer id = aftersale.getId();
        DashboardAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
            return ResponseUtil.badArgumentValue();
        ...
        DashboardOrder order = orderService.findById(orderId);
