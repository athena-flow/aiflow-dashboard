...
public class AdminAdminController {
    ...
    public Object list(String username,
        ...
        List<DashboardAdmin> adminList = adminService.querySelective(username, page, limit, sort, order);
        return ResponseUtil.okList(adminList);
    }

    private Object validate(DashboardAdmin admin) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody DashboardAdmin admin) {
        ...
        List<DashboardAdmin> adminList = adminService.findAdmin(username);
        if (adminList.size() > 0) {
    ...
    public Object read(@NotNull Integer id) {
        DashboardAdmin admin = adminService.findById(id);
        return ResponseUtil.ok(admin);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody DashboardAdmin admin) {
        Object error = validate(admin);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody DashboardAdmin admin) {
        Integer anotherAdminId = admin.getId();
        if (anotherAdminId == null) {
            return ResponseUtil.badArgument();
        }
        ...
        DashboardAdmin currentAdmin = (DashboardAdmin) currentUser.getPrincipal();
