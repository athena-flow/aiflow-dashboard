...
import com.aiflow.dashboard.db.service.DashboardAdService;
...
public class AdminAdController {
    ...
    public Object list(String name, String content,
        ...
        List<DashboardAd> adList = adService.querySelective(name, content, page, limit, sort, order);
        return ResponseUtil.okList(adList);
    }

    private Object validate(DashboardAd ad) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody DashboardAd ad) {
    ...
    public Object read(@NotNull Integer id) {
        DashboardAd ad = adService.findById(id);
        return ResponseUtil.ok(ad);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody DashboardAd ad) {
        Object error = validate(ad);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody DashboardAd ad) {
        Integer id = ad.getId();
        if (id == null) {
            return ResponseUtil.badArgument();
        }
