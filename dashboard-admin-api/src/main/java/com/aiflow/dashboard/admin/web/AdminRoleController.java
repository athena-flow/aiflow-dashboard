...
import static com.aiflow.dashboard.admin.util.AdminResponseCode.ROLE_NAME_EXIST;
import static com.aiflow.dashboard.admin.util.AdminResponseCode.ROLE_USER_EXIST;
...
public class AdminRoleController {
    ...
    public Object list(String name,
        ...
        List<DashboardRole> roleList = roleService.querySelective(name, page, limit, sort, order);
        return ResponseUtil.okList(roleList);
    }

    @GetMapping("/options")
    public Object options() {
        List<DashboardRole> roleList = roleService.queryAll();
    ...
    public Object read(@NotNull Integer id) {
        DashboardRole role = roleService.findById(id);
        return ResponseUtil.ok(role);
    }


    private Object validate(DashboardRole role) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody DashboardRole role) {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody DashboardRole role) {
        Object error = validate(role);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody DashboardRole role) {
    ...
    public Object updatePermissions(@RequestBody String body) {
        ...
        for (String permission : permissions) {
            ...
            dashboardPermission.setRoleId(roleId);
            dashboardPermission.setPermission(permission);
            permissionService.add(dashboardPermission);
        }
        return ResponseUtil.ok();
    }
