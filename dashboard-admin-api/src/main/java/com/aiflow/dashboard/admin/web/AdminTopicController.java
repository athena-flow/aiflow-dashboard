...
public class AdminTopicController {
    ...
    public Object list(String title, String subtitle,
        ...
        List<DashboardTopic> topicList = topicService.querySelective(title, subtitle, page, limit, sort, order);
        return ResponseUtil.okList(topicList);
    }

    private Object validate(DashboardTopic topic) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody DashboardTopic topic) {
    ...
    public Object read(@NotNull Integer id) {
        ...
        List<DashboardGoods> goodsList = null;
    ...
    @PostMapping("/update")
    public Object update(@RequestBody DashboardTopic topic) {
        Object error = validate(topic);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody DashboardTopic topic) {
