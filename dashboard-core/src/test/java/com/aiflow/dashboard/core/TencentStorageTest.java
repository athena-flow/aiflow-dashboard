...
import com.aiflow.dashboard.core.storage.TencentStorage;
...
public class TencentStorageTest {
    ...
    public void test() throws IOException {
        ...
        tencentStorage.store(new FileInputStream(test), testFile.length(), "image/png", "dashboard.png");
        Resource resource = tencentStorage.loadAsResource("dashboard.png");
        String url = tencentStorage.generateUrl("dashboard.png");
