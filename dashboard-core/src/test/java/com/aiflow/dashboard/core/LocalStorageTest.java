...
import com.aiflow.dashboard.core.storage.LocalStorage;
...
public class LocalStorageTest {
    ...
    public void test() throws IOException {
        ...
        localStorage.store(new FileInputStream(test), testFile.length(), "image/png", "dashboard.png");
        Resource resource = localStorage.loadAsResource("dashboard.png");
        String url = localStorage.generateUrl("dashboard.png");
