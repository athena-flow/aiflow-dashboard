package com.aiflow.dashboard.core.qcode;

import cn.binarywang.wx.miniapp.api.WxMaService;
import me.chanjar.weixin.common.error.WxErrorException;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import com.aiflow.dashboard.core.storage.StorageService;
...
public class QCodeService {
    ...
    public String createGrouponShareImage(String goodName, String goodPicUrl, DashboardGroupon groupon) {
        try {
            //创建该商品的二维码
            ...
            //存储分享图
            DashboardStorage storageInfo = storageService.store(inputStream2, imageData.length, "image/jpeg",
    ...
    public String createGoodShareImage(String goodId, String goodPicUrl, String goodName) {
        ...
        try {
            ...
            ByteArrayInputStream inputStream2 = new ByteArrayInputStream(imageData);
            //存储分享图
            DashboardStorage dashboardStorage = storageService.store(inputStream2, imageData.length, "image/jpeg",
                    getKeyName(goodId));

            return dashboardStorage.getUrl();
        } catch (WxErrorException e) {
            logger.error(e.getMessage(), e);
        } catch (FileNotFoundException e) {
            logger.error(e.getMessage(), e);
