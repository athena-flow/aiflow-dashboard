...
import com.aiflow.dashboard.wx.service.GetRegionService;
...
public class WxAddressController extends GetRegionService {
	...
	public Object list(@LoginUser Integer userId) {
		...
		List<DashboardAddress> addressList = addressService.queryByUid(userId);
	...
	public Object detail(@LoginUser Integer userId, @NotNull Integer id) {
		...
		DashboardAddress address = addressService.query(userId, id);
		if (address == null) {
	...
	private Object validate(DashboardAddress address) {
	 ...
	 */
	@PostMapping("save")
	public Object save(@LoginUser Integer userId, @RequestBody DashboardAddress address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
		...
		if (address.getId() == null || address.getId().equals(0)) {
			...
			DashboardAddress dashboardAddress = addressService.query(userId, address.getId());
	 ...
	 */
	@PostMapping("delete")
	public Object delete(@LoginUser Integer userId, @RequestBody DashboardAddress address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
		...
		DashboardAddress dashboardAddress = addressService.query(userId, id);
		if (dashboardAddress == null) {
			return ResponseUtil.badArgumentValue();
		}
