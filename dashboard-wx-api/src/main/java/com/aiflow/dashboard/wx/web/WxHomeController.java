...
public class WxHomeController {
    ...
    @Autowired
    private DashboardAdService adService;
    ...
    private List<Map> getCategoryList() {
        ...
        List<DashboardCategory> catL1List = categoryService.queryL1WithoutRecommend(0, SystemConfig.getCatlogListLimit());
        for (DashboardCategory catL1 : catL1List) {
            List<DashboardCategory> catL2List = categoryService.queryByPid(catL1.getId());
            List<Integer> l2List = new ArrayList<>();
            for (DashboardCategory catL2 : catL2List) {
                l2List.add(catL2.getId());
            }

            List<DashboardGoods> categoryGoods;
            if (l2List.size() == 0) {
