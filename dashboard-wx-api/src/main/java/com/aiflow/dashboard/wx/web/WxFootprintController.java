...
public class WxFootprintController {
    ...
    public Object delete(@LoginUser Integer userId, @RequestBody String body) {
        ...
        DashboardFootprint footprint = footprintService.findById(userId, footprintId);
    ...
    public Object list(@LoginUser Integer userId,
        ...
        List<DashboardFootprint> footprintList = footprintService.queryByAddTime(userId, page, limit);

        List<Object> footprintVoList = new ArrayList<>(footprintList.size());
        for (DashboardFootprint footprint : footprintList) {
            Map<String, Object> c = new HashMap<String, Object>();
            c.put("id", footprint.getId());
            c.put("goodsId", footprint.getGoodsId());
            c.put("addTime", footprint.getAddTime());

            DashboardGoods goods = goodsService.findById(footprint.getGoodsId());
