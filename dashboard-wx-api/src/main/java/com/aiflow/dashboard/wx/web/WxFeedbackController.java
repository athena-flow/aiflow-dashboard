...
import com.aiflow.dashboard.db.service.DashboardFeedbackService;
...
public class WxFeedbackController {
    ...
    @Autowired
    private DashboardFeedbackService feedbackService;
    @Autowired
    private DashboardUserService userService;

    private Object validate(DashboardFeedback feedback) {
     ...
     */
    @PostMapping("submit")
    public Object submit(@LoginUser Integer userId, @RequestBody DashboardFeedback feedback) {
        if (userId == null) {
