...
import com.aiflow.dashboard.core.util.CharUtil;
import com.aiflow.dashboard.core.util.JacksonUtil;
import com.aiflow.dashboard.core.util.RegexUtil;
...
import com.aiflow.dashboard.db.service.CouponAssignService;
...
import com.aiflow.dashboard.wx.dto.WxLoginInfo;
import com.aiflow.dashboard.wx.service.CaptchaCodeManager;
...
public class WxAuthController {
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        List<DashboardUser> userList = userService.queryByUsername(username);
    ...
    public Object loginByWeixin(@RequestBody WxLoginInfo wxLoginInfo, HttpServletRequest request) {
        ...
        DashboardUser user = userService.queryByOid(openId);
        if (user == null) {
    ...
    public Object register(@RequestBody String body, HttpServletRequest request) {
        ...
        if(!StringUtils.isEmpty(wxCode)) {
            ...
            if (userList.size() == 1) {
                DashboardUser checkUser = userList.get(0);
    ...
    public Object reset(@RequestBody String body, HttpServletRequest request) {
        ...
        List<DashboardUser> userList = userService.queryByMobile(mobile);
        DashboardUser user = null;
        if (userList.size() > 1) {
            return ResponseUtil.serious();
        } else if (userList.size() == 0) {
