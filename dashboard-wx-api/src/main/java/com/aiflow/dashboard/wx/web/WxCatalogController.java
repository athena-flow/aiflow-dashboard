...
import com.aiflow.dashboard.wx.service.HomeCacheManager;
...
public class WxCatalogController {
    ...
    public Object getSecondCategory(@NotNull Integer id) {
        // 所有二级分类目录
        List<DashboardCategory> currentSubCategory = categoryService.queryByPid(id);
    ...
    public Object index(Integer id) {
        ...
        // 当前一级分类目录
        DashboardCategory currentCategory = null;
        if (id != null) {
        ...
        // 当前一级分类目录对应的二级分类目录
        List<DashboardCategory> currentSubCategory = null;
    ...
    public Object queryAll() {
        ...
        //所有子分类列表
        Map<Integer, List<DashboardCategory>> allList = new HashMap<>();
        List<DashboardCategory> sub;
        ...
        // 当前一级分类目录
        DashboardCategory currentCategory = l1CatList.get(0);
    ...
    public Object current(@NotNull Integer id) {
        // 当前分类
        DashboardCategory currentCategory = categoryService.findById(id);
        if(currentCategory == null){
            return ResponseUtil.badArgumentValue();
        }
        List<DashboardCategory> currentSubCategory = categoryService.queryByPid(currentCategory.getId());
