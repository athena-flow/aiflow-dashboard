...
import com.aiflow.dashboard.wx.service.UserInfoService;
...
public class WxCommentController {
    ...
    private Object validate(DashboardComment comment) {
     ...
     */
    @PostMapping("post")
    public Object post(@LoginUser Integer userId, @RequestBody DashboardComment comment) {
        if (userId == null) {
    ...
    public Object list(@NotNull Byte type,
        ...
        List<DashboardComment> commentList = commentService.query(type, valueId, showType, page, limit);

        List<Map<String, Object>> commentVoList = new ArrayList<>(commentList.size());
        for (DashboardComment comment : commentList) {
