  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      <div class="title-container">
        <h3 class="title">aiflow-dashboard</h3>
      </div>
      ...
      <div style="position:relative">
        <div class="tips">
          <span>aiflow-dashboard</span>
        </div>
      </div>
    </el-form>

    <div class="copyright">
      Copyright © 2020 aiflow.com 版权所有 <a href="http://www.beian.miit.gov.cn/publish/query/indexFirst.action">京ICP备16044936号-1</a>
    </div>
  </div>
</template>
